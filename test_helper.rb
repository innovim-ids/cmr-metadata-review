...
# Next line changed from capybara/rails to capybara - JS

require 'capybara/rails/capybara'
...
# commented JS next 3 lines removes capybara
...
class ActiveSupport::TestCase
     # Run tests in parallel with specified workers added for 6.1.3 next line
